...
namespace NaughtyAttributes.Editor
{
    ...
    public static class ValidatorAttributeExtensions
    {
        ...
        static ValidatorAttributeExtensions()
        {
            ...
            _validatorsByAttributeType[typeof(AssetsOnlyAttribute)] = new AssetsOnlyPropertyValidator();
            _validatorsByAttributeType[typeof(SceneOnlyAttribute)] = new SceneOnlyPropertyValidator();
        }
